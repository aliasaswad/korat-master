...
public class TestCradle extends AbstractTestCaseGenerator implements ITester {
    ...
    //public static boolean toJump = false;// Alyas
    ...
    protected void startTestGeneration(IFinitization fin)
        ...
        //System.out.println(totalNumberOfFields);
        //System.out.println(accessedFields);
        //System.out.println(stateSpace.getRootObject());
        ...
        while (!interrupted) {
            ...
            //alyas
            //System.out.println("A_"+testCase);
            //if (a_flag >= 1)
            //    testCase = stateSpaceExplorer.nextTestCase();
            //a_flag ++;
            //alyas/
        ...
        else System.out.println ("CV jump opt done");
